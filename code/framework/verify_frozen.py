...
def main():
    ...
    ap.add_argument("--repo-root", type=Path, default=None,
                    help="Repo root (default: parent of revise_bioadv/scripts/)")
    ...
    manifest_path = repo_root / "revise_bioadv" / "frozen_signatures" / "MANIFEST.json"
    ...
    script_path = repo_root / "revise_bioadv" / "scripts" / script_rel
