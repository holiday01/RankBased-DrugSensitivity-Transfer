...
Outputs:
  revise_bioadv/external_data/<gse>/series_matrix.txt.gz
  revise_bioadv/external_data/<gse>/<platform>_annot.csv (probe -> symbol map)
  revise_bioadv/external_data/<gse>/DOWNLOAD_LOG.json (timestamps, sha256, URLs)
"""
...
OUT_ROOT = Path("/home/holiday01/2026_ISMB_code/revise_bioadv/external_data")
